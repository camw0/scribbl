...
<div class="br-8 bg-indigo-lightest-10 p-5 md-p-l5 flex flex-wrap md-justify-between md-items-center">
    <div class="w-100pc md-w-33pc">
        ...
        <div class="my-5">
            <a href="/login">
                <button class="button-md bg-indigo indigo-lightest bw-0 fw-300 fs-s3">
    ...
    <form method="POST" action="{{ route('register') }}" class="w-100pc md-w-50pc">
        ...
        @enderror
        <div class="flex my-5">
            <input id="email" name="email" value="{{ old('email') }}" required autocomplete="email" type="email" placeholder="Email Address"
        ...
        <div class="flex my-5">
            <input id="name" name="name" value="{{ old('name') }}" required autocomplete="name" type="text" placeholder="Username"
                class="form-control input-lg flex-grow-1 bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5"
            />
        </div>
        <div class="flex my-5">
            <input id="password" name="password" required autocomplete="new-password" type="password" placeholder="Password"
                class="form-control input-lg flex-grow-1 bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5"
            />
        </div>
        <div class="flex my-5">
