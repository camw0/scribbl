        ...
        <div class="mx-5 md-mx-l5">
            <div>
                <div class="w-100pc mx-auto py-10">
                    <h2 class="white fs-l2 md-fs-xl1 fw-900 lh-2">Scribbl is a minimalistic, secure and <span
                            class="border-b bc-indigo bw-4">fast</span> place to store your notes.</h2>
                </div>
                <div class="br-8 mt-5 inline-flex">
                    @guest @if (Route::has('login'))
                        ...
                        @endif @if (Route::has('register'))
                            <a href="/register"
                                class="white ml-8 fs-l3 no-underline border-b bc-indigo bw-4">Register</a>
                        @endif
                    @else
                        <a href="/dashboard" class="white fs-l3 no-underline border-b bc-indigo bw-4">Dashboard</a>
                        <a href="{{ route('logout') }}" class="white ml-8 fs-l3 no-underline border-b bc-indigo bw-4"
