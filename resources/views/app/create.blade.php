...
<div class="br-8 bg-indigo-lightest-10 p-5 md-p-l5 flex flex-wrap md-justify-between md-items-center">
	<form method="POST" action="{{ route('app.create.new') }}" class="w-100pc md-w-100pc">
		...
		<br />
		<input id="title" name="title" type="text" required placeholder="'Shopping List', 'Plans for the future', 'How to dispose of a body'..."
		...
		<br />
		<textarea
			required rows="5" id="description" name="description"
